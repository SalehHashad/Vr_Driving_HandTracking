...
//    {
//        private GearJoystickController gearController;
//        [Header("Grab Object")]
...
//        [SerializeField] private FloatEventChannelSO gearOne;

//        private void Awake()
//        {
//            vehicleController = FindObjectOfType<VehicleController>();
//            gearController = FindObjectOfType<GearJoystickController>();
//        }

//        private void OnEnable()
//        {
//            // gearOne.OnEventRaised += vehicleController.SetMotorTorqueInput;
//        }
...
//            {
//                float speedFactor = Mathf.Clamp((angleX - MinXAngle) / (MaxXAngle - MinXAngle), 0, 1);

//                if (yInput == -1)
//                {
//                    //vehicleController.IsBrake = true;
...
//                    //if(vehicleController.IsBrake == false)
//                    //{
//                    //    print("Falssssssssssssssssssssssssse");
//                    //    vehicleController.SetMotorTorqueInput(yInput * speedFactor);
//                    //}
//                    //vehicleController.BrakeForce = 0;
//                    Debug.Log("Motor input is : " + vehicleController.MotorInput);
//                    if (gearController.isForward == true)
//                    {
//                        vehicleController.SetMotorTorqueInput(yInput * speedFactor);
//                    }
//                    if (gearController.isBackward == true)
//                    {
//                        vehicleController.SetMotorTorqueInputInverted(yInput * speedFactor);
//                    }
//                }
//            }
//        }
