...
public class ESShowForwardDirection : MonoBehaviour
{
    ...
    [SerializeField]
    private Vector3 ArrowSize = new Vector3(6f, 0.125f, 6f);
    ...
    private void OnDrawGizmos()
    {
        ...
        if (mesh != null)
            Gizmos.DrawMesh(mesh.GetComponent<MeshFilter>().sharedMesh, -1, (this.transform.position), this.transform.rotation, ArrowSize);
    }
}