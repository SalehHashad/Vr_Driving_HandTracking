            ...
            case 1:
                {
                    ...
                    else
                    {
                        ...
                        Transform RightFootIkHintTarget = null;
                        Transform LeftFootIkHintTarget = null;
                        ...
                        if (scripts.TestModelTrans != null)
                        {
                            ...
                            //
                            RightFootIkHintTarget = EditorGUILayout.ObjectField("RightLegIKHintTarget", scripts.RightHint, typeof(Transform), true) as Transform;
                            LeftFootIkHintTarget = EditorGUILayout.ObjectField("LeftLegIKHintTarget", scripts.LeftHint, typeof(Transform), true) as Transform;
                        ...
                        if (EditorGUI.EndChangeCheck())
                        {
                            ...
                            scripts.LeftHint = LeftFootIkHintTarget;
                            scripts.RightHint = RightFootIkHintTarget;
